...
exports.DatastoreAdminClient = exports.DatastoreClient = exports.v1 = exports.Transaction = exports.Query = exports.DatastoreRequest = exports.Index = exports.Datastore = exports.or = exports.and = exports.PropertyFilter = exports.Key = void 0;
/**
 * @namespace google
 */
/**
...
class Datastore extends request_1.DatastoreRequest {
    constructor(options) {
        ...
        const isUsingEmulator = this.baseUrl_ &&
    ...
    createAggregationQuery(query) {
        return new aggregate_1.AggregateQuery(query);
    }
